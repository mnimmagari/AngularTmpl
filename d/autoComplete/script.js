...
.directive('userauto', function() {
  return {
    ...
    templateUrl: '/d/autoComplete/templates/user-picker.html',
    scope: {
      userModel: "=userModel",
      userId: "=userId",
      userEmail: "=userEmail",
    ...
    link : function(scope,element,attrs)
    {
      scope.getTemplate = function(){
        ...
        {
          return "/d/autoComplete/templates/smallpanel.html";
        }
        if(viewmode === "large"){
          return "/d/autoComplete/templates/largepanel.html";
        }
        if(viewmode === "medium"){
          return "/d/autoComplete/templates/mediumpanel.html";
        }
      }
    }
  };
