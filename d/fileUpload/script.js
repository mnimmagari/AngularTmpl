...
.controller('fileuploadDirectiveControllerMain', ['$scope', '$http','$mdDialog', '$mdMedia','Upload','growl', function($scope, $http, $mdDialog, $mdMedia,Upload,growl) {
  ...
  $scope.showfileUploadButton = function(ev) {
    $mdDialog.show({
      ...
      templateUrl: '/d/fileUpload/templates/fileUploadDialog.html',
...
.directive('fileupload', function() {
  return {
    ...
    templateUrl: '/d/fileUpload/templates/fileUpload.html',
    scope: {
   ...
   link : function(scope,element,attrs)
   {
    scope.getTemplate = function(){
      ...
      {
        return "/d/fileUpload/templates/fileProfileUpload.html";
      }
      if(foldertype === "entity"){
        return "/d/fileUpload/templates/fileEntityUpload.html";
      }
      if(foldertype === "location"){
        return "/d/fileUpload/templates/fileLocationUpload.html";
      }
