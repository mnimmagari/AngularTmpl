...
.directive('user', function() {
  return {
    ...
    templateUrl: '/d/user/templates/user-picker.html',
    scope: {
      userModel: "=userModel",
      userId: "=userId",
      userEmail: "=userEmail",
    ...
    link : function(scope,element,attrs)
    {
      scope.getTemplate = function(){
        ...
        {
          return "/d/user/templates/smallpanel.html";
        }
        if(viewmode === "large"){
          return "/d/user/templates/largepanel.html";
        }
        if(viewmode === "medium"){
          return "/d/user/templates/mediumpanel.html";
        }
