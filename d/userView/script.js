...
.directive('userview', function() {
  return {
    ...
    templateUrl: '/d/userView/templates/userView.html',
    scope: {
      userId: "=userId",
      viewMode: "@viewMode",
      userModel: "=userModel"
    ...
    link : function(scope,element,attrs)
    {
      scope.getTemplate = function()
      {
        ...
        if(viewmode === "bullet-small"){
          return "/d/userView/templates/bulletSmall.html";
        }
        if(viewmode === "brief-view"){
          return "/d/userView/templates/briefView.html";
        }
        if(viewmode === "detial-view"){
          return "/d/userView/templates/detailView.html";
        }
